                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="">
                                    <i class="fa fa-user"></i> Hi <?php echo (session()->get('name')." (".session()->get('role').") "); ?>
                                </a>
                            </li>
                            <br>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="/user/janapdf">
                                    <i class="fa fa-list"></i> JanaPDF
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="/login/index">
                                    <i class="fa fa-list"></i> Logout
                                </a>
                            </li>
                        </ul>
                    </div>
